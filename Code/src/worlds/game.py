from worlds.keys_world import KeysWorld
from worlds.symbol_world import SymbolWorld
from worlds.cookie_world import CookieWorld
from worlds.waiter_world import WaiterWorld
...
class Game:
    ...
    def restart(self):
        ...
        if self.params.game_type == 'waiterworld':
            self.game = WaiterWorld(self.params.game_params)
